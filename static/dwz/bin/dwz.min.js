...
$.pdialog.open(DWZ._set.loginUrl,"login",DWZ._set.loginTitle,{mask:true,width:520,height:260,modeWin:DWZ._set.modeWin});}else{
...
this._reload($tab,true,forwardUrl);}else{
...
if(json.navTabId){
navTab.reloadFlag(json.navTabId,json.forwardUrl);}else{
